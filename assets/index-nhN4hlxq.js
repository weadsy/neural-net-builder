 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Em;function Wv(){if(Em)return bt;Em=1;var a=Symbol.for("react.transitional.element"),i=Symbol.for("react.portal"),l=Symbol.for("react.fragment"),s=Symbol.for("react.strict_mode"),c=Symbol.for("react.profiler"),d=Symbol.for("react.consumer"),f=Symbol.for("react.context"),g=Symbol.for("react.forward_ref"),p=Symbol.for("react.suspense"),h=Symbol.for("react.memo"),y=Symbol.for("react.lazy"),v=Symbol.iterator;function x(T){return T===null||typeof T!="object"?null:(T=v&&T[v]||T["@@iterator"],typeof T=="function"?T:null)}var w={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},M=Object.assign,O={};function _(T,H,I){this.props=T,this.context=H,this.refs=O,this.updater=I||w}_.prototype.isReactComponent={},_.prototype.setState=function(T,H){if(typeof T!="object"&&typeof T!="function"&&T!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,T,H,"setState")},_.prototype.forceUpdate=function(T){this.updater.enqueueForceUpdate(this,T,"forceUpdate")};function B(){}B.prototype=_.prototype;function X(T,H,I){this.props=T,this.context=H,this.refs=O,this.updater=I||w}var q=X.prototype=new B;q.constructor=X,M(q,_.prototype),q.isPureReactComponent=!0;var W=Array.isArray,P={H:null,A:null,T:null,S:null,V:null},F=Object.prototype.hasOwnProperty;function Q(T,H,I,J,it,gt){return I=gt.ref,{$$typeof:a,type:T,key:H,ref:I!==void 0?I:null,props:gt}}function G(T,H){return Q(T.type,H,void 0,void 0,void 0,T.props)}function lt(T){return typeof T=="object"&&T!==null&&T.$$typeof===a}function ct(T){var H={"=":"=0",":":"=2"};return"$"+T.replace(/[=:]/g,function(I){return H[I]})}var jt=/\/+/g;function Zt(T,H){return typeof T=="object"&&T!==null&&T.key!=null?ct(""+T.key):H.toString(36)}function Ne(){}function pe(T){switch(T.status){case"fulfilled":return T.value;case"rejected":throw T.reason;default:switch(typeof T.status=="string"?T.then(Ne,Ne):(T.status="pending",T.then(function(H){T.status==="pending"&&(T.status="fulfilled",T.value=H)},function(H){T.status==="pending"&&(T.status="rejected",T.reason=H)})),T.status){case"fulfilled":return T.value;case"rejected":throw T.reason}}throw T}function Qt(T,H,I,J,it){var gt=typeof T;(gt==="undefined"||gt==="boolean")&&(T=null);var ot=!1;if(T===null)ot=!0;else switch(gt){case"bigint":case"string":case"number":ot=!0;break;case"object":switch(T.$$typeof){case a:case i:ot=!0;break;case y:return ot=T._init,Qt(ot(T._payload),H,I,J,it)}}if(ot)return it=it(T),ot=J===""?"."+Zt(T,0):J,W(it)?(I="",ot!=null&&(I=ot.replace(jt,"$&/")+"/"),Qt(it,H,I,"",function(Be){return Be})):it!=null&&(lt(it)&&(it=G(it,I+(it.key==null||T&&T.key===it.key?"":(""+it.key).replace(jt,"$&/")+"/")+ot)),H.push(it)),1;ot=0;var Ut=J===""?".":J+":";if(W(T))for(var Et=0;Et<T.length;Et++)J=T[Et],gt=Ut+Zt(J,Et),ot+=Qt(J,H,I,gt,it);else if(Et=x(T),typeof Et=="function")for(T=Et.call(T),Et=0;!(J=T.next()).done;)J=J.value,gt=Ut+Zt(J,Et++),ot+=Qt(J,H,I,gt,it);else if(gt==="object"){if(typeof T.then=="function")return Qt(pe(T),H,I,J,it);throw H=String(T),Error("Objects are not valid as a React child (found: "+(H==="[object Object]"?"object with keys {"+Object.keys(T).join(", ")+"}":H)+"). If you meant to render a collection of children, use an array instead.")}return ot}function k(T,H,I){if(T==null)return T;var J=[],it=0;return Qt(T,J,"","",function(gt){return H.call(I,gt,it++)}),J}function Z(T){if(T._status===-1){var H=T._result;H=H(),H.then(function(I){(T._status===0||T._status===-1)&&(T._status=1,T._result=I)},function(I){(T._status===0||T._status===-1)&&(T._status=2,T._result=I)}),T._status===-1&&(T._status=0,T._result=H)}if(T._status===1)return T._result.default;throw T._result}var $=typeof reportError=="function"?reportError:function(T){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var H=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof T=="object"&&T!==null&&typeof T.message=="string"?String(T.message):String(T),error:T});if(!window.dispatchEvent(H))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",T);return}console.error(T)};function pt(){}return bt.Children={map:k,forEach:function(T,H,I){k(T,function(){H.apply(this,arguments)},I)},count:function(T){var H=0;return k(T,function(){H++}),H},toArray:function(T){return k(T,function(H){return H})||[]},only:function(T){if(!lt(T))throw Error("React.Children.only expected to receive a single React element child.");return T}},bt.Component=_,bt.Fragment=l,bt.Profiler=c,bt.PureComponent=X,bt.StrictMode=s,bt.Suspense=p,bt.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=P,bt.__COMPILER_RUNTIME={__proto__:null,c:function(T){return P.H.useMemoCache(T)}},bt.cache=function(T){return function(){return T.apply(null,arguments)}},bt.cloneElement=function(T,H,I){if(T==null)throw Error("The argument must be a React element, but you passed "+T+".");var J=M({},T.props),it=T.key,gt=void 0;if(H!=null)for(ot in H.ref!==void 0&&(gt=void 0),H.key!==void 0&&(it=""+H.key),H)!F.call(H,ot)||ot==="key"||ot==="__self"||ot==="__source"||ot==="ref"&&H.ref===void 0||(J[ot]=H[ot]);var ot=arguments.length-2;if(ot===1)J.children=I;else if(1<ot){for(var Ut=Array(ot),Et=0;Et<ot;Et++)Ut[Et]=arguments[Et+2];J.children=Ut}return Q(T.type,it,void 0,void 0,gt,J)},bt.createContext=function(T){return T={$$typeof:f,_currentValue:T,_currentValue2:T,_threadCount:0,Provider:null,Consumer:null},T.Provider=T,T.Consumer={$$typeof:d,_context:T},T},bt.createElement=function(T,H,I){var J,it={},gt=null;if(H!=null)for(J in H.key!==void 0&&(gt=""+H.key),H)F.call(H,J)&&J!=="key"&&J!=="__self"&&J!=="__source"&&(it[J]=H[J]);var ot=arguments.length-2;if(ot===1)it.children=I;else if(1<ot){for(var Ut=Array(ot),Et=0;Et<ot;Et++)Ut[Et]=arguments[Et+2];it.children=Ut}if(T&&T.defaultProps)for(J in ot=T.defaultProps,ot)it[J]===void 0&&(it[J]=ot[J]);return Q(T,gt,void 0,void 0,null,it)},bt.createRef=function(){return{current:null}},bt.forwardRef=function(T){return{$$typeof:g,render:T}},bt.isValidElement=lt,bt.lazy=function(T){return{$$typeof:y,_payload:{_status:-1,_result:T},_init:Z}},bt.memo=function(T,H){return{$$typeof:h,type:T,compare:H===void 0?null:H}},bt.startTransition=function(T){var H=P.T,I={};P.T=I;try{var J=T(),it=P.S;it!==null&&it(I,J),typeof J=="object"&&J!==null&&typeof J.then=="function"&&J.then(pt,$)}catch(gt){$(gt)}finally{P.T=H}},bt.unstable_useCacheRefresh=function(){return P.H.useCacheRefresh()},bt.use=function(T){return P.H.use(T)},bt.useActionState=function(T,H,I){return P.H.useActionState(T,H,I)},bt.useCallback=function(T,H){return P.H.useCallback(T,H)},bt.useContext=function(T){return P.H.useContext(T)},bt.useDebugValue=function(){},bt.useDeferredValue=function(T,H){return P.H.useDeferredValue(T,H)},bt.useEffect=function(T,H,I){var J=P.H;if(typeof I=="function")throw Error("useEffect CRUD overload is not enabled in this build of React.");return J.useEffect(T,H)},bt.useId=function(){return P.H.useId()},bt.useImperativeHandle=function(T,H,I){return P.H.useImperativeHandle(T,H,I)},bt.useInsertionEffect=function(T,H){return P.H.useInsertionEffect(T,H)},bt.useLayoutEffect=function(T,H){return P.H.useLayoutEffect(T,H)},bt.useMemo=function(T,H){return P.H.useMemo(T,H)},bt.useOptimistic=function(T,H){return P.H.useOptimistic(T,H)},bt.useReducer=function(T,H,I){return P.H.useReducer(T,H,I)},bt.useRef=function(T){return P.H.useRef(T)},bt.useState=function(T){return P.H.useState(T)},bt.useSyncExternalStore=function(T,H,I){return P.H.useSyncExternalStore(T,H,I)},bt.useTransition=function(){return P.H.useTransition()},bt.version="19.1.0",bt}var wm;function gf(){return wm||(wm=1,wc.exports=Wv()),wc.exports}var Y=gf();const Vt=Kv(Y);var Rc={exports:{}},dl={},Cc={exports:{}},zc={};/**
 * @license React
...
}`,gT="data:image/svg+xml,%3csvg%20xmlns='http://www.w3.org/2000/svg'%20width='22'%20height='18'%20viewBox='0%200%2022%2018'%3e%3cg%3e%3cpolygon%20points='15.828%206%2018%206%2018%208%2022%204%2018%200%2018%202%2014.172%202%204.172%2012%200%2012%200%2016%205.828%2016%2015.828%206'/%3e%3cpolygon%20points='18%2010%2018%2012%2015.828%2012%2014.242%2010.414%2011.414%2013.242%2014.172%2016%2018%2016%2018%2018%2022%2014%2018%2010'/%3e%3cpolygon%20points='5.758%207.586%208.586%204.758%205.828%202%200%202%200%206%204.172%206%205.758%207.586'/%3e%3c/g%3e%3c/svg%3e",nn=({matrix:a,label:i,image:l,x:s=0,y:c=0})=>{if(!a||a.length===0)return null;const d=a.length,f=a[0]?.length||0,g=40,p=4;return A.jsxs("div",{className:"matrix-display",style:{position:"relative",fontFamily:"monospace",color:"white"},children:[i&&A.jsx("div",{className:"matrix-label",style:{position:"absolute",top:"-2.2rem",left:"50%",transform:"translateX(-50%)",fontSize:"18px",fontWeight:"bold",whiteSpace:"nowrap"},children:A.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",gap:"8px"},children:[A.jsx("span",{children:i}),l]})}),A.jsxs("div",{className:"matrix-container",style:{position:"relative"},children:[A.jsx("div",{className:"matrix-bracket-left",style:{position:"absolute",left:"-8px",top:"0",height:`${d*(g+p)-p}px`,width:"6px",borderLeft:"2px solid white",borderTop:"2px solid white",borderBottom:"2px solid white"}}),A.jsx("div",{className:"matrix-bracket-right",style:{position:"absolute",right:"-8px",top:"0",height:`${d*(g+p)-p}px`,width:"6px",borderRight:"2px solid white",borderTop:"2px solid white",borderBottom:"2px solid white"}}),A.jsx("div",{className:"matrix-content",children:a.map((h,y)=>A.jsx("div",{className:"matrix-row",style:{display:"flex",marginBottom:y<d-1?`${p}px`:"0"},children:h.map((v,x)=>A.jsx("div",{className:"matrix-cell",style:{width:`${g}px`,height:`${g}px`,display:"flex",alignItems:"center",justifyContent:"center",fontSize:"14px",marginRight:x<f-1?`${p}px`:"0"},children:typeof v=="number"?v.toFixed(1):v},x))},y))})]})]})},no=({children:a,delay:i=0,isVisible:l=!0})=>A.jsx(Gt.div,{initial:{opacity:0},animate:{opacity:l?1:0},transition:{delay:i,duration:.5},style:{display:"flex",alignItems:"center",gap:"20px",marginBottom:"40px"},children:a}),ao=({symbol:a})=>A.jsx("div",{style:{fontSize:"24px",color:"white",fontWeight:"bold"},children:a}),rg=({label:a,label2:i,children:l})=>A.jsxs("div",{style:{display:"flex",flexDirection:"column",alignItems:"center",gap:"5px"},children:[A.jsx("div",{style:{fontSize:"16px",color:"white",fontWeight:"bold",backgroundColor:"rgb(6, 129, 0)",border:"2px solid #22c55e",borderRadius:"8px",padding:"2px 8px"},children:a}),A.jsx("img",{src:gT,alt:"Activation Arrow",style:{width:"24px",height:"24px",filter:"invert(1)"}}),A.jsxs("div",{style:{fontSize:"16px",color:"white"},children:[" ",i," "]}),l]}),yT=({matrixSteps:a})=>A.jsx(Gt.div,{initial:{opacity:0,scaleY:0},animate:{opacity:a.showDivider?1:0,scaleY:a.showDivider?1:0},transition:{duration:.8},style:{width:"5px",height:"30rem",backgroundColor:"white",margin:"0 60px",transformOrigin:"top"}}),sg=!0;function bT(){const[a,i]=Y.useState([]),[l,s]=Y.useState([]),[c,d]=Y.useState(!1),[f,g]=Y.useState(1),[p,h]=Y.useState(null),[y,v]=Y.useState(null),[x,w]=Y.useState({input:0,hidden:0,output:0,...Array.from({length:10},(V,K)=>({[`hidden${K+2}`]:0})).reduce((V,K)=>({...V,...K}),{})}),[M,O]=Y.useState([{}]),[_,B]=Y.useState({}),[X,q]=Y.useState({}),[W,P]=Y.useState({}),[F,Q]=Y.useState({}),[G,lt]=Y.useState({}),[ct,jt]=Y.useState(null),[Zt,Ne]=Y.useState({x:0,y:0}),[pe,Qt]=Y.useState(null),[k,Z]=Y.useState({}),[$,pt]=Y.useState([]),[T,H]=Y.useState([]),[I,J]=Y.useState([]),[it,gt]=Y.useState(!1),[ot,Ut]=Y.useState(!1),[Et,Be]=Y.useState(!1),[Nt,It]=Y.useState(!1),[Kt,Ct]=Y.useState([]),[et,Tt]=Y.useState(0),[wt,Mt]=Y.useState(!1),[ge,ie]=Y.useState(null),[Ze,xe]=Y.useState(!1),[on,Nn]=Y.useState(5),[kn,Xn]=Y.useState(!1),[ke,Se]=Y.useState(!1),[mn,Le]=Y.useState(null),[As,kl]=Y.useState(null),[_l,mi]=Y.useState(!0),[pi,On]=Y.useState(!1),[xt,He]=Y.useState({});function Oe(V,K){let yt=-1*(on-5)/10*V;return K&&yt<0&&(yt=Math.max(0,yt)),new Promise(kt=>setTimeout(kt,V+yt))}Y.useEffect(()=>{if(!localStorage.getItem("neuralNetworkData")){xe(!0);const V=setTimeout(()=>xe(!1),6e3);return()=>clearTimeout(V)}},[]),Y.useEffect(()=>{const V=K=>{K.key==="`"&&Xn(st=>!st)};return window.addEventListener("keydown",V),()=>{window.removeEventListener("keydown",V)}},[]);const Xa=Y.useRef(null),Je=30,po=400;let Yn=[];const jl=()=>{fT(M,Qe,Pe,Ee,G,_,X,W,F,V=>{Yn=V.predictions,pt(V.predictions),H(V.truthValues),J(V.losses),gt(V.showResults)})},Vl=async()=>{if(Pe.length===0)return;Ut(!0),gt(!1),await Oe(500),On(!0);const V=M.filter(rt=>{const $t=Qe.some(We=>rt[We.label]&&rt[We.label].trim()!==""),Jt=rt.Truth!==void 0&&rt.Truth!=="";return $t&&Jt});if(V.length===0){alert("Please add input data with truth values"),Ut(!1),On(!1);return}const K=V.map(rt=>Qe.map($t=>parseFloat(rt[$t.label])||0)),st=Qe.map(rt=>Pe.map($t=>{const Jt=G[rt.label]||rt.label,We=G[$t.label]||$t.label;return _[`${Jt}-${We}`]||0})),yt=Pe.map(rt=>{const $t=G[rt.label]||rt.label;return X[$t]||0}),kt=Array(K.length).fill(yt),dt=K.map(rt=>st[0].map(($t,Jt)=>rt.reduce((We,pa,Ga)=>We+pa*st[Ga][Jt],0))),At=dt.map(rt=>rt.map(($t,Jt)=>$t+yt[Jt])),Bt=At.map(rt=>rt.map($t=>Math.max(0,$t)));let te,we,fe,ma,bo,Ya;const bi=Ee.length>0;bi&&(te=Pe.map(rt=>Ee.map($t=>{const Jt=G[rt.label]||rt.label,We=G[$t.label]||$t.label;return W[`${Jt}-${We}`]||0})),we=Ee.map(rt=>{const $t=G[rt.label]||rt.label;return F[$t]||0}),fe=Array(Bt.length).fill(we),ma=Bt.map(rt=>te[0].map(($t,Jt)=>rt.reduce((We,pa,Ga)=>We+pa*te[Ga][Jt],0))),bo=ma.map(rt=>rt.map(($t,Jt)=>$t+we[Jt])),Ya=bo.map(rt=>rt.map($t=>1/(1+Math.exp(-$t))))),He({step:1,X:K,W1:st,b1:yt,XW1:dt,b1Matrix:kt,Z1:At,A1:Bt,W2:te,b2:we,b2Matrix:fe,A1W2:ma,Z2:bo,A2:Ya,hasOutputLayer:bi,showFormula:!1,showXW1:!1,showZ1:!1,showReLU:!1,showDivider:!1,showLayer2Formula:!1,showA1W2:!1,showZ2:!1,showSigmoid:!1}),await Oe(1e3),He(rt=>({...rt,showFormula:!0})),await Oe(1500),He(rt=>({...rt,showXW1:!0})),await Oe(1500),He(rt=>({...rt,showZ1:!0})),await Oe(1e3),He(rt=>({...rt,showReLU:!0})),bi&&(await Oe(1500),He(rt=>({...rt,showDivider:!0})),await Oe(1e3),He(rt=>({...rt,showLayer2Formula:!0})),await Oe(1500),He(rt=>({...rt,showA1W2:!0})),await Oe(1500),He(rt=>({...rt,showZ2:!0})),await Oe(1e3),He(rt=>({...rt,showSigmoid:!0})))},Ul=V=>{ke&&(i(K=>K.filter(st=>st.id!==V)),s(K=>K.filter(st=>st.fromNeuronId!==V&&st.toNeuronId!==V)),v(null),Le(null))},go=V=>{ke&&(s(K=>K.filter(st=>st.id!==V)),h(null),kl(null))},yo=async()=>{if(_l){if(Pe.length===0)return;Ut(!0),gt(!1),It(!0),Tt(0),Mt(!1),ie(null);const V=async K=>{const st=Pe[K];if(!st)return;const yt=l.filter(dt=>dt.toNeuronId===st.id&&Qe.some(At=>At.id===dt.fromNeuronId)).map(dt=>dt.id);Ct(dt=>Array.from(new Set([...dt,...yt]))),await Oe(3e3);const kt=l.filter(dt=>dt.fromNeuronId===st.id&&Ee.some(At=>At.id===dt.toNeuronId)).map(dt=>dt.id);Ct(dt=>Array.from(new Set([...dt,...kt]))),await Oe(2e3),Ct(dt=>dt.filter(At=>!yt.includes(At)))};for(let K=0;K<Pe.length;K++)await V(K);if(Mt(!0),await Oe(3e3),jl(),Ee.length>0&&Yn.length>0){const K=Ee[0],st=Yn[0].toFixed(4),yt={id:`display-${Date.now()}`,x:K.x+150,y:K.y,radius:30,label:st,type:"display"};ie(yt),i(dt=>[...dt,yt]);const kt={id:`sigmoid-connection-${Date.now()}`,fromNeuronId:K.id,toNeuronId:yt.id,fromDirection:"right",toDirection:"left",isSigmoidConnection:!0};s(dt=>[...dt,kt]),Ct(dt=>[...dt,kt.id])}await Oe(2e3),Ut(!1),await Oe(4e3,sg),Mt(!1),i(K=>K.filter(st=>st.type!=="display")),s(K=>K.filter(st=>!st.isSigmoidConnection)),Ct([]),await Oe(700,sg),It(!1)}else await Vl(),jl()},Bl=V=>{const{setNeuronHeaders:K,setHiddenWeights:st,setHiddenBiases:yt,setOutputWeights:kt,setOutputBiases:dt}=V;return{handleInputHeaderChange:(At,Bt)=>{K(te=>({...te,[At]:Bt}))},handleWeightChange:(At,Bt,te)=>{st(we=>({...we,[`${At}-${Bt}`]:parseFloat(te)||0}))},handleBiasChange:(At,Bt)=>{yt(te=>({...te,[At]:parseFloat(Bt)||0}))},handleOutputWeightChange:(At,Bt,te)=>{kt(we=>({...we,[`${At}-${Bt}`]:parseFloat(te)||0}))},handleOutputBiasChange:(At,Bt)=>{dt(te=>({...te,[At]:parseFloat(Bt)||0}))},handleNeuronHeaderChange:(At,Bt)=>{K(te=>({...te,[At]:Bt}))}}},{handleInputHeaderChange:Ds,handleWeightChange:_n,handleBiasChange:Me,handleOutputWeightChange:qe,handleOutputBiasChange:ua,handleNeuronHeaderChange:gi}=Bl({setNeuronHeaders:lt,setHiddenWeights:B,setHiddenBiases:q,setOutputWeights:P,setOutputBiases:Q}),Ll=()=>{const V=a.filter(yt=>yt.type!=="display"),K=l.filter(yt=>!yt.isSigmoidConnection),st={inputData:M,hiddenWeights:_,hiddenBiases:X,outputWeights:W,outputBiases:F,neuronHeaders:G,neurons:V,connections:K,counters:x,timestamp:new Date().toISOString()};localStorage.setItem("neuralNetworkData",JSON.stringify(st))},Hl=()=>{xe(!1);let V=localStorage.getItem("neuralNetworkData");V||(V=lg,localStorage.setItem("neuralNetworkData",lg));try{const K=JSON.parse(V);O(K.inputData||[{}]),B(K.hiddenWeights||{}),q(K.hiddenBiases||{}),P(K.outputWeights||{}),Q(K.outputBiases||{}),lt(K.neuronHeaders||{}),K.neurons&&i(K.neurons),K.connections&&(s(K.connections),Be(!0)),K.counters&&w(K.counters)}catch(K){console.error("Error loading network data:",K)}},yi=(V,K,st)=>{if(V==="connection"&&K&&st){const yt=a.find(dt=>(G[dt.label]||dt.label)===K),kt=a.find(dt=>(G[dt.label]||dt.label)===st);if(yt&&kt){const dt=l.find(At=>At.fromNeuronId===yt.id&&At.toNeuronId===kt.id);h(dt?.id||null)}v(null)}else if(V==="neuron"&&K){const yt=a.find(kt=>(G[kt.label]||kt.label)===K);v(yt?.id||null),h(null)}else h(null),v(null)},Qe=a.filter(V=>V.type==="input").sort((V,K)=>V.y-K.y),Pe=a.filter(V=>V.type==="hidden").sort((V,K)=>V.y-K.y),Ee=a.filter(V=>V.type==="output").sort((V,K)=>V.y-K.y),ca=Qe.map(V=>G[V.label]||V.label),fa=Pe.map(V=>G[V.label]||V.label),da=Ee.map(V=>G[V.label]||V.label),ce=V=>{if(!Xa.current)return{x:0,y:0};const K=Xa.current.getBoundingClientRect(),st=(V.clientX-K.left)/K.width*800,yt=(V.clientY-K.top)/K.height*400;return{x:st,y:yt}},ql=(V,K,st)=>{Z(yt=>({...yt,[V]:{x:K,y:st}}))},Pl=Y.useCallback(V=>{if(ct&&Xa.current){const K=ce(V);Ne(K);let st=null,yt=1/0;a.forEach(kt=>{if(kt.id!==ct.fromNeuronId){const dt=k[kt.id]||{x:0,y:0},At=kt.x+dt.x,Bt=kt.y+dt.y;[{direction:"top",x:At,y:Bt-Je},{direction:"right",x:At+Je,y:Bt},{direction:"bottom",x:At,y:Bt+Je},{direction:"left",x:At-Je,y:Bt}].forEach(we=>{const fe=Math.sqrt(Math.pow(K.x-we.x,2)+Math.pow(K.y-we.y,2));fe<15&&fe<yt&&(yt=fe,st={neuronId:kt.id,direction:we.direction})})}}),Qt(st)}},[ct,a,k,Je]),Gn=V=>{mT(V,x,i,w,f,po,Je)},ha=(V,K,st)=>{i(yt=>yt.map(kt=>kt.id===V?{...kt,x:K,y:st}:kt))},Os=(V,K,st,yt,kt)=>{if(ct)if(V!==ct.fromNeuronId){const dt={id:`connection-${Date.now()}`,fromNeuronId:ct.fromNeuronId,toNeuronId:V,fromDirection:ct.fromDirection,toDirection:K};s(At=>[...At,dt]),jt(null),Qt(null)}else jt(null),Qt(null);else{const dt=a.find(ma=>ma.id===V),At=k[V]||{x:0,y:0},Bt=dt.x+At.x,te=dt.y+At.y,we={top:{x:Bt,y:te-Je},right:{x:Bt+Je,y:te},bottom:{x:Bt,y:te+Je},left:{x:Bt-Je,y:te}},fe=ce(kt);jt({fromNeuronId:V,fromDirection:K,startX:we[K].x,startY:we[K].y}),Ne(fe)}},Xl=()=>{pT(a,s,Be)},Yl=V=>{V.target.classList.contains("network-svg")&&ct&&(jt(null),Qt(null))},Gl=({type:V,label:K,onClickFunc:st=()=>Gn(V),style:yt={padding:"0.7rem 1.5rem"}})=>A.jsx(Gt.button,{onClick:st,className:"spawn-btn",whileHover:{scale:1.05,borderColor:"#ffffff"},whileTap:{scale:.95},initial:{opacity:0,y:20},animate:{opacity:1,y:-25},transition:{delay:.1,duration:.1},style:yt,children:K},V);return A.jsxs("div",{className:"app-container",children:[A.jsxs("div",{style:{position:"fixed",top:0,left:10,zIndex:100,background:"transparent",padding:"18px 24px 0 24px",color:"white",fontSize:"1rem",letterSpacing:"0.04em"},children:[A.jsx("a",{href:"../matrix_tool/",style:{color:"white",fontWeight:300,marginRight:"24px"},children:"Home"}),A.jsx("a",{href:"https://www.linkedin.com/in/laish-glenberg/",style:{color:"white",fontWeight:300,marginRight:"24px"},children:"About"}),A.jsx("a",{href:"https://ko-fi.com/weadsy",style:{color:"white",fontWeight:300,marginRight:"24px"},children:"Donate"})]}),A.jsxs(Gt.div,{className:"content-wrapper-with-tables",initial:{opacity:0,scale:.8},animate:{opacity:1,scale:1},transition:{duration:1,ease:"easeOut"},children:[A.jsxs("div",{className:"left-panel",children:[A.jsx(ig,{title:"Input Col Vectors",neurons:Qe,data:M,setData:O,onHeaderChange:Ds,onCellHover:yi,isOutput:!1}),ot&&A.jsx("div",{style:{minHeight:"300px",display:"flex",alignItems:"center",justifyContent:"center",width:"100%"},children:A.jsx(tg,{color:["#7e7e7e","#979797","#b1b1b1","#cacaca"]})}),it&&!ot&&A.jsx(Gt.div,{initial:{opacity:0,y:30,scale:.95},animate:{opacity:1,y:0,scale:1},transition:{duration:.7,ease:"easeOut"},children:A.jsx(ig,{title:"Final Predictions",neurons:[],data:[],setData:()=>{},onHeaderChange:()=>{},onCellHover:()=>{},isOutput:!0,truthValues:T,predictions:$,losses:I})})]}),A.jsxs("div",{className:"center-panel",children:[A.jsxs("div",{className:"main-title-row",style:{display:"flex",alignItems:"center",justifyContent:"center",width:"100%",marginBottom:"5px",position:"relative"},children:[A.jsx(Gt.h1,{className:"main-title",initial:{opacity:0,y:-30},animate:{opacity:1,y:10},transition:{delay:.3,duration:.8},style:{margin:0},children:"Neural Network Builder"}),A.jsxs("div",{className:"save-load-buttons",style:{position:"absolute",right:0,top:"50%",transform:"translateY(-50%)"},children:[A.jsx("button",{className:"save-load-btn",title:"Save all table values in cookies",onClick:Ll,style:{marginRight:"8px"},children:"Save"}),A.jsx("button",{className:`save-load-btn${Ze?" flash":""}`,title:"Load tables from cookies",onClick:Hl,children:"Load"})]})]}),a.some(V=>V.type==="output")&&a.some(V=>V.type==="input")&&a.some(V=>V.type==="hidden")&&A.jsxs("div",{style:{display:"flex",flexDirection:"row",alignItems:"center",gap:"10px",marginTop:"10px"},children:[A.jsxs("label",{className:"checkbox-container",style:{display:"flex",alignItems:"center",gap:"8px",color:"white",fontSize:"1rem",border:"2px solid rgba(255,255,255,0.3)",borderRadius:"8px",padding:"0.7rem 0.5rem"},children:[A.jsx("input",{type:"checkbox",checked:_l,onChange:V=>mi(V.target.checked),style:{transform:"scale(1.2)",accentColor:"#ffffff"}}),"Deep Solve"]}),A.jsx(Gt.button,{onClick:yo,className:`spawn-btn${Et?"":" btn-disabled"}`,style:{fontSize:"16px",padding:"0.7rem 1.2rem",display:"flex",alignItems:"center",justifyContent:"center",whiteSpace:"nowrap",opacity:ot?.5:1,cursor:ot?"not-allowed":"pointer"},disabled:!Et||ot,whileHover:{scale:1.05,borderColor:"#ffffff"},whileTap:{scale:.95},initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{delay:.1,duration:.1},children:ot?A.jsx(tg,{color:"#ffffff",size:"small"}):A.jsxs(A.Fragment,{children:["START",A.jsx("img",{src:BS,alt:"Train",style:{marginLeft:"10px",width:22,height:22,filter:"invert(1)",transform:"scaleX(-1)"}})]})}),A.jsxs("label",{className:"speedbox-container",style:{border:"2px solid rgba(255, 255, 255, 0.3)",borderRadius:"8px",padding:"0.7rem 0.5rem",display:"flex",alignItems:"center",gap:"0.5rem",marginRight:"12px"},children:[A.jsx("input",{type:"number",min:0,max:kn?20:9,step:1,value:on,onChange:V=>Nn(Number(V.target.value)),className:"eraser-checkbox ishovered",style:{width:"38px",background:"transparent",color:"white",border:"1px solid rgba(255,255,255,0.3)",borderRadius:"4px",fontSize:"1rem",padding:"2px 6px",minHeight:"25px"}}),A.jsx("span",{className:"eraser-label",children:"Speed"})]})]}),A.jsx(ey,{children:pi&&A.jsx(Gt.div,{className:"matrix-calculations-overlay",initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{delay:.1,duration:1},style:{position:"absolute",top:"0",left:"0",width:"100%",height:"100%",backgroundColor:"rgba(0, 0, 0, 0.95)",zIndex:1e3,overflow:"hidden",padding:"50px",fontFamily:"monospace"},children:xt.step>=1&&A.jsxs("div",{style:{display:"flex",flexDirection:"row",gap:"20px",justifyContent:"space-around",alignItems:"center"},children:[A.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"20px"},children:[A.jsx("div",{style:{display:"flex",flexDirection:"column",maxWidth:"auto",alignItems:"center",justifyContent:"center"},children:A.jsx("div",{style:{position:"relative",fontSize:"28px",color:"white",fontWeight:"bold",border:"2px solid rgba(255, 255, 255, 0.3)",borderRadius:"8px",marginBottom:"5px",top:"-20px",padding:"0px 20px"},children:"HIDDEN WEIGHTED SUMS"})}),A.jsxs(no,{delay:0,isVisible:xt.showFormula,children:[A.jsx("div",{style:{fontSize:"24px",color:"white",fontWeight:"bold"},children:"Z1 ="}),A.jsx(nn,{matrix:xt.X,label:"X"}),A.jsx(ao,{symbol:"×"}),A.jsx(nn,{matrix:xt.W1,label:"W1"}),A.jsx(ao,{symbol:"+"}),A.jsx(nn,{matrix:[xt.b1],label:"b1",image:A.jsx("img",{src:eg,alt:"Activation Arrow",style:{transform:"scaleX(1.27)",height:"20px",filter:"invert(1)"}})})]}),A.jsxs(no,{delay:0,isVisible:xt.showXW1,children:[A.jsx("div",{style:{fontSize:"24px",color:"white",fontWeight:"bold"},children:"Z1 ="}),A.jsx(nn,{matrix:xt.XW1,label:"X * W1"}),A.jsx(ao,{symbol:"+"}),A.jsx(nn,{matrix:xt.b1Matrix,label:"b1"})]}),A.jsxs(no,{delay:0,isVisible:xt.showZ1,children:[A.jsxs(Gt.div,{initial:{x:xt.showReLU?-25:0},animate:{x:xt.showReLU?-25:0},transition:{duration:.5},style:{display:"flex",alignItems:"center",gap:"20px"},children:[A.jsx("div",{style:{fontSize:"24px",color:"white",fontWeight:"bold"},children:"Z1 ="}),A.jsx(nn,{matrix:xt.Z1,label:"X * W1 + b1"})]}),A.jsxs(Gt.div,{initial:{opacity:0,x:50},animate:{opacity:xt.showReLU?1:0,x:0},transition:{delay:.5,duration:.5},style:{display:"flex",alignItems:"center",gap:"20px"},children:[A.jsx(rg,{label:"ReLU",label2:"max(0,Z1)"}),A.jsx("div",{style:{fontSize:"24px",color:"white",fontWeight:"bold"},children:"A1 ="}),A.jsx(nn,{matrix:xt.A1,label:"ReLU(Z1)"})]})]})]}),A.jsxs("div",{style:{display:"flex",flexDirection:"column",alignItems:"center",opacity:xt.showDivider&&xt.hasOutputLayer?1:0,transition:"opacity 0.5s ease"},children:[A.jsx(yT,{matrixSteps:xt}),A.jsx(Gt.div,{initial:{opacity:0,y:20},animate:{opacity:xt.showSigmoid?1:0,y:0},transition:{delay:1,duration:.5},style:{marginTop:"40px",display:"flex",justifyContent:"center",alignItems:"center",width:"100%"},children:A.jsx(Gt.button,{onClick:()=>{Ut(!1),On(!1),gt(!0)},className:"spawn-btn",whileHover:{scale:1.05,borderColor:"#ffffff"},whileTap:{scale:.95},style:{fontSize:"16px",padding:"10px 20px",display:"flex",alignItems:"center",justifyContent:"center",whiteSpace:"nowrap"},children:"Continue"})})]}),A.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"20px",opacity:xt.hasOutputLayer?1:0,transition:"opacity 0.5s ease"},children:[A.jsx("div",{style:{display:"flex",flexDirection:"column",maxWidth:"auto",alignItems:"center",justifyContent:"center"},children:A.jsx(Gt.div,{initial:{opacity:0},animate:{opacity:xt.showDivider?1:0},transition:{delay:.5,duration:.5},style:{position:"relative",fontSize:"28px",color:"white",fontWeight:"bold",border:"2px solid rgba(255, 255, 255, 0.3)",borderRadius:"8px",marginBottom:"5px",top:"-20px",padding:"0px 20px"},children:"OUTPUT WEIGHTED SUMS"})}),A.jsxs(no,{delay:0,isVisible:xt.showLayer2Formula,children:[A.jsx("div",{style:{fontSize:"24px",color:"white",fontWeight:"bold"},children:"Z2 ="}),A.jsx(nn,{matrix:xt.A1,label:"A1"}),A.jsx(ao,{symbol:"×"}),A.jsx(nn,{matrix:xt.W2,label:"W2"}),A.jsx(ao,{symbol:"+"}),A.jsx(nn,{matrix:[xt.b2],label:"b2",image:A.jsx("img",{src:eg,alt:"Activation Arrow",style:{transform:"scaleX(1.27)",height:"20px",filter:"invert(1)"}})})]}),A.jsxs(no,{delay:0,isVisible:xt.showA1W2,children:[A.jsx("div",{style:{fontSize:"24px",color:"white",fontWeight:"bold"},children:"Z2 ="}),A.jsx(nn,{matrix:xt.A1W2,label:"A1 * W2"}),A.jsx(ao,{symbol:"+"}),A.jsx(nn,{matrix:xt.b2Matrix,label:"b2"})]}),A.jsxs(no,{delay:0,isVisible:xt.showZ2,children:[A.jsxs(Gt.div,{initial:{x:xt.showSigmoid?-25:0},animate:{x:xt.showSigmoid?-25:0},transition:{duration:.5},style:{display:"flex",alignItems:"center",gap:"20px"},children:[A.jsx("div",{style:{fontSize:"24px",color:"white",fontWeight:"bold"},children:"Z2 ="}),A.jsx(nn,{matrix:xt.Z2,label:"A1 * W2 + b2"})]}),A.jsxs(Gt.div,{initial:{opacity:0,x:50},animate:{opacity:xt.showSigmoid?1:0,x:0},transition:{delay:.5,duration:.5},style:{display:"flex",alignItems:"center",gap:"20px"},children:[A.jsx(rg,{label:"Sigmoid",children:A.jsx("svg",{width:"80",height:"40",style:{display:"block"},children:A.jsx(Xy,{x:40,y:20,sumText:"x"})})}),A.jsx("div",{style:{fontSize:"24px",color:"white",fontWeight:"bold"},children:"ŷ ="}),A.jsx(nn,{matrix:xt.A2,label:"σ(Z2)"})]})]})]})]})})}),A.jsxs("div",{style:{position:"relative",width:"100%"},children:[A.jsxs(Gt.svg,{ref:Xa,width:"100%",height:"400",viewBox:"0 0 800 400",className:"network-svg",initial:{opacity:0},animate:{opacity:1},transition:{delay:.6,duration:1},onMouseMove:Pl,onClick:Yl,style:{cursor:ke?"crosshair":"default"},children:[A.jsx("defs",{children:A.jsx("marker",{id:"arrowhead",markerWidth:"10",markerHeight:"7",refX:"9",refY:"3.5",orient:"auto",children:A.jsx("polygon",{points:"0 0, 10 3.5, 0 7",className:"arrow-marker"})})}),l.map(V=>A.jsx(oT,{connection:V,neurons:a,neuronRadius:Je,neuronTransforms:k,isGlowing:p===V.id,emphasizedConnections:Kt,showForwardPassVisuals:Nt,inputData:M,currentSampleIndex:et,neuronHeaders:G,hiddenWeights:_,inputNeurons:Qe,hiddenNeurons:Pe,hiddenBiases:X,outputWeights:W,outputBiases:F,showSigmoidPhase:wt,outputNeurons:Ee,isEraserMode:ke,onEraseConnection:go,eraserHoveredConnection:As,setEraserHoveredConnection:kl},V.id)),ct&&A.jsx(iT,{startX:ct.startX,startY:ct.startY,endX:Zt.x,endY:Zt.y}),a.map(V=>A.jsx(rT,{id:V.id,x:V.x,y:V.y,radius:V.radius,label:V.label,type:V.type,onDragEnd:ha,onDragUpdate:ql,onStartConnection:Os,highlightedDots:pe?.neuronId===V.id?[pe.direction]:[],isGlowing:y===V.id,neurons:a,showForwardPassVisuals:Nt,emphasizedConnections:Kt,hiddenNeurons:Pe,inputNeurons:Qe,outputNeurons:Ee,neuronHeaders:G,hiddenWeights:_,outputWeights:W,inputData:M,currentSampleIndex:et,hiddenBiases:X,connections:l,showSigmoidPhase:wt,outputBiases:F,isEraserMode:ke,onEraseNeuron:Ul,eraserHoveredNeuron:mn,setEraserHoveredNeuron:Le},V.id))]}),A.jsx("div",{style:{position:"absolute",top:16,right:-5,zIndex:10},children:A.jsxs("label",{className:"eraser-checkbox-container",style:{border:"2px solid rgba(255, 255, 255, 0.3)",borderRadius:"8px",padding:"0.5rem",background:"rgba(0,0,0,0.7)"},children:[A.jsx("input",{type:"checkbox",checked:ke,onChange:V=>Se(V.target.checked),className:"eraser-checkbox"}),A.jsx("span",{className:"eraser-label",children:"Eraser"})]})})]}),A.jsxs("div",{className:"button-stack",style:{},children:[A.jsx("div",{className:"button-container",children:[{type:"input",label:"Add Input"},{type:"hidden",label:"Add Hidden"},...c?Array.from({length:f-1},(V,K)=>({type:`hidden${K+2}`,label:`Add Hidden ${K+2}`})):[],{type:"output",label:"Add Output"}].map(({type:V,label:K})=>Gl({type:V,label:K}))}),A.jsx("div",{className:"button-dense",children:a.some(V=>V.type==="input")&&a.some(V=>V.type==="hidden")&&Gl({type:"dense",label:"Dense Connect",onClickFunc:Xl,style:{padding:"0.5rem 0.7rem",background:"rgba(255, 255, 255, 0.05)"}})})]})]}),A.jsxs("div",{className:"right-panel",children:[A.jsx(og,{title:"Hidden Layer Weights",inputLabels:ca,neuronLabels:fa,weights:_,biases:X,onWeightChange:_n,onBiasChange:Me,onHeaderChange:gi,showSaveLoad:!0,onSave:Ll,onLoad:Hl,onCellHover:yi,biasLabel:"b1"}),Pe.length>0&&Ee.length>0&&A.jsx(og,{title:"Output Layer Weights",inputLabels:fa,neuronLabels:da,weights:W,biases:F,onWeightChange:qe,onBiasChange:ua,onHeaderChange:gi,showSaveLoad:!1,onCellHover:yi,biasLabel:"b2"})]})]})]})}i1.createRoot(document.getElementById("root")).render(A.jsx(Y.StrictMode,{children:A.jsx(bT,{})}));
